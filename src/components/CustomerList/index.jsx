      ...
      const fetchActivityLogs = useCallback(async () => {
        try {
          ...
          for (const customer of customers) {
            ...
            if (error) {
              console.error(`Error fetching activity log for customer ${customer.id}:`, error);
              continue;
            }
            logs[customer.id] = data;
          }
                ...
                <tbody>
                  {customers.map((customer, index) => (
                    <React.Fragment key={index}>
                      ...
                      <tr>
                        <td colSpan="10">
                          <ActivityLog logs={activityLogs[customer.id] || []} />
                        </td>
                      </tr>
                    </React.Fragment>
                  ))}
